...
namespace Modul05_DataGridView.DataLayer
{
    ...
    public partial class AdventureWorks2017DbContext : DbContext
    {
        public AdventureWorks2017DbContext()
            : base("name=AdventureWorks2017DbContext")
        {
        ...
        [DbFunction("AdventureWorks2017DbContext", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2017DbContext].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
