...
namespace Modul05_DataGridView.AdventureWorks2017DataSetTableAdapters {
...
SELECT TOP (10) ProductID, Name, ProductNumber, MakeFlag, FinishedGoodsFlag, Color, SafetyStockLevel, ReorderPoint, StandardCost, ListPrice, Size, SizeUnitMeasureCode, WeightUnitMeasureCode, Weight, DaysToManufacture, ProductLine, Class, Style, ProductSubcategoryID, ProductModelID, SellStartDate, SellEndDate, DiscontinuedDate, rowguid, ModifiedDate FROM Production.Product WHERE (ProductID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Production].[Product] SET [Name] = @Name, [ProductNumber] = @ProductNumbe" +
                ...
                "ifiedDate] = @Original_ModifiedDate));\r\nSELECT TOP (10) ProductID, Name, Product" +
                "Number, MakeFlag, FinishedGoodsFlag, Color, SafetyStockLevel, ReorderPoint, Stan" +
                "dardCost, ListPrice, Size, SizeUnitMeasureCode, WeightUnitMeasureCode, Weight, D" +
                "aysToManufacture, ProductLine, Class, Style, ProductSubcategoryID, ProductModelI" +
                "D, SellStartDate, SellEndDate, DiscontinuedDate, rowguid, ModifiedDate FROM Prod" +
                "uction.Product WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Modul05_DataGridView.Properties.Settings.Default.AdventureWorks2017ConnectionString;
        }
